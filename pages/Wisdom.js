...
const Wisdom = () => {
    ...
    const backgroundImage = 'https://illusionquote-author-images.s3.ap-south-1.amazonaws.com/Wisdom.jpg';
    const category = 'Wisdom';
    ...
    return (
        ...
        <Head>
          ...
          <meta name="keywords" content="motivational, quotes, wise quotes, wisdom" />
